...
#[AsCommand(
    name: 'app:worker:restart-all',
)]
class WorkerRestartAllCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($workers as $worker) {
            $this->commandBus->dispatch(new RestartWorkerCommand($worker->name));
        }

        $io->success(sprintf('%d Workers were restarted.', $workers->count()));
